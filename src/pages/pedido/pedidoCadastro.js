...
export const PedidoCadastro = () => {
    ...
    return (
        <div className="p-d-flex p-jc-center">
            ...
            <div className="card" style={{ marginRight: 10, width: 700 }}>
                <h5>Pedido</h5>
            ...
            <div className="card" style={{ marginLeft: 10, width: 400 }}>
                <div className="card">
                    <ScrollPanel style={{ width: '100%', height: '100%', flexDirection: 'row' }}>
                        <h4>Produtos</h4>
